...
const Home = ({ navigation }) => {
  ...
  const restaurantData = [
    {
      id: 1,
      name: "Preethi Srikanth",
      Category: "Cleaning",
      Address: "Embassy Residency",
      rating: 4.8,
      categories: [1, 5, 7],
    ...
    {
      id: 2,
      name: "Madhumitha Shankar",
      Category: "Gardening",
      Address: "Hiranandhani",
      empname: "Somya Panchal",
      rating: 4.8,
      categories: [2, 4, 6],
    ...
    },
    {
      ...
      Address: "Welcome apartments",
      empname: "Manasi Kenkere",
      rating: 4.8,
      categories: [3, 8, 1],
      priceRating: expensive,
      photo: icons.senior,
    ...
    },
    {
      ...
      name: "Pooja",
      Category: "Gardening",
      Address: "Orchid apartments",
      empname: "Kamakshi Vohra",
      rating: 4.8,
      categories: [1, 7, 2],
      priceRating: affordable,
      photo: icons.salon,
    ...
    },
    {
      ...
      Address: "Okay apartments",
      empname: "Lynnea Doshi",
      rating: 4.9,
      categories: [6, 4],
      priceRating: affordable,
      photo: icons.baby,
  ...
  function renderRestaurantList() {
    const renderItem = ({ item }) => (
      <View style={{ marginBottom: 0 }}>
        ...
        >
          {item.name} has been appointed for {item.Category} at {item.Address}{" "}
          by {item.empname}
        </Text>
        <View
          style={{
